        ...
        <TooltipPrimitive.Portal>
            <TooltipPrimitive.Content
                ...
                className={cn(
                    ...
                    items-center gap-1.5 rounded-md bg-foreground px-3 py-1.5
                    text-xs text-background has-data-[slot=kbd]:pr-1.5
            ...
            >
                ...
                <TooltipPrimitive.Arrow
                    className="z-50 size-2.5 translate-y-[calc(-50%_-_2px)]
