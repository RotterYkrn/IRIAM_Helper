    ...
    return (
        <Comp
            ...
            className={cn(
                ...
                font-medium text-sidebar-foreground/70 ring-sidebar-ring
                outline-hidden transition-[margin,opacity] duration-200
                ease-linear group-data-[collapsible=icon]:-mt-8
    ...
    return (
        <Comp
            ...
            className={cn(
                ...
                group-data-[collapsible=icon]:hidden after:absolute
                after:-inset-2 hover:bg-sidebar-accent
    ...
    return (
        <Comp
            ...
            className={cn(
                ...
                peer-data-[size=sm]/menu-button:top-1 after:absolute
                after:-inset-2 hover:bg-sidebar-accent
                hover:text-sidebar-accent-foreground focus-visible:ring-2
                md:after:hidden [&>svg]:size-4 [&>svg]:shrink-0`,
                showOnHover &&
    ...
    return (
        <Comp
            ...
            className={cn(
                ...
                group-data-[collapsible=icon]:hidden hover:bg-sidebar-accent
                hover:text-sidebar-accent-foreground focus-visible:ring-2
